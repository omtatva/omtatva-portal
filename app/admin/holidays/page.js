...
const upcoming=holidays.find(item=>
...
<h1>
{
upcoming.name || upcoming.holidayName
}
</h1>
...
🏷️ 
{
upcoming.category || upcoming.type
}
...
value={holidayDate}
onChange={
e=>setHolidayDate(e.target.value)
}
/>
...
value={holidayType}
onChange={
e=>setHolidayType(e.target.value)
}
>
...
box-shadow:
0 6px 15px rgba(61,111,168,0.25);
...
background:
linear-gradient(135deg,#3d6fa8,#60a5fa);
